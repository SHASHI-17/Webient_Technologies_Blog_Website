...
export const PostDetails = () => {
  ...
  return (
    ...
    <img src={IF+post?.photo}
     className='w-[500px] h-[500px] mx-auto mt-8' alt="" />
    ...
    {/* writing a comment  */}
            <div className='flex w-full flex-col mt-4 md:flex-row'>
                 <input onChange={(e)=>{setComment(e.target.value)}} type="text" className='md:w-[80%] outline-none py-2 px-4 mt-4 md:mt-0' placeholder='Write a Comment' />
